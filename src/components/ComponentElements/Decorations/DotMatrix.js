export default function DotMatrix(props) {
  if (props.display) {
    return (
      <svg
        className=" testimonial-dotmatrix testimonial-dotmatrix-desktop"
        width="241"
        height="298"
        viewBox="0 0 241 298"
        fill="none"
      ...
      >
        ...
        <defs>
          <clipPath id="clip0_399_317">
            <rect width="241" height="298" fill="white" />
          </clipPath>
        </defs>
      </svg>
    );
    ...
    return (
      <svg
        className=" testimonial-dotmatrix testimonial-dotmatrix-mobile"
        width="202"
        height="135"
        viewBox="0 0 202 135"
        fill="none"
